...
func _ready():
	...
	match difficulty:
		App_Game.Type_Difficulty.EASY: change_clor_text_button(btn_easy, App_Game.EASY_COLOR)
		App_Game.Type_Difficulty.MEDIUM: change_clor_text_button(btn_medium, App_Game.MEDIUM_COLOR)
		App_Game.Type_Difficulty.HARD: change_clor_text_button(btn_hard, App_Game.HARD_COLOR)
...
func _on_easy_pressed():
	...
	no_focus_button()
	change_clor_text_button(btn_easy, App_Game.EASY_COLOR)
	App_Game.save_game(game)
...
func _on_medium_pressed():
	...
	no_focus_button()
	change_clor_text_button(btn_medium, App_Game.MEDIUM_COLOR)
	App_Game.save_game(game)
...
func _on_hard_pressed():
	...
	no_focus_button()
	change_clor_text_button(btn_hard, App_Game.HARD_COLOR)
	App_Game.save_game(game)
